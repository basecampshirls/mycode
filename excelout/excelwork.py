...
def get_ip_data():
    ...
    input_ip2 = input("What is the second IP address?")
    input_driver2 = input("What is the driver associated with this device? ")
    d = {"IP": input_ip, "driver": input_driver, "IPs": input_ip2, "input_driver2": input_driver2}
    return d
...
while(True):
   ...
   # {"IP": value, "driver": value} # did you write this line? I'm commenting it out.

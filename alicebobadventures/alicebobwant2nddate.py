...
input ("Press ENTER to take the encrypted message and hide it in the dog picture.")
...
startdecrypt = input ('Want to see if Alice got the message? Type yes if you do. ')
if startdecrypt.lower() == "yes":
    print ('Great, this is fun isn\'t it? Let\'s pull that encrypted message out of the picture.') 
elif startdecrypt.lower() != "yes":
    print ('Well at least you did your part in helping Bob. See you!')
    sys.exit()

#use Stegano decrypt
input ("Press ENTER to see the message hidden in the picture.")
clear_message = lsb.reveal("/home/student/static/dogpics/dog2.png")
print ('\nHere\'s the hidden message: ')
print (str(clear_message))

#use Alice's private key to decrypt
message2 = rsa.decrypt(clear_message, ALICE_PRIV)
